...
public class NesneProje {
    ...
    private CalisanEkleStrategy calisanEkleStrategy;

    public void setCalisanEkleStrategy(CalisanEkleStrategy calisanEkleStrategy) {
        this.calisanEkleStrategy = calisanEkleStrategy;
    }

    public void calisanEkle(int id, String ad, String soyad, int yas, int maas) {
        // Departman bağlamında çalışan ekleme stratejisini kullanarak çalışan ekleme işlemleri
        calisanEkleStrategy.calisanEkle(id, ad, soyad, yas, maas);
    }
    ...
    public void connection() {
        try{
            Class.forName("org.postgresql.Driver");
                    Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/proje", "postgres", "kadir1253");
    ...
    public void maasGuncelle(int id, int yeniMaas){
        try {
            ...
            this.c = DriverManager.getConnection("jdbc:postgresql://localhost:5432/proje","postgres","kadir1523");
            this.st = this.c.createStatement();
    ...
    public void departmanEkle(int departman_no, String departman_adi){
        ...
        try {
            ...
            this.c = DriverManager.getConnection("jdbc:postgresql://localhost:5432/proje","postgres","1253");
            this.st = this.c.createStatement();
                    int rs = st.executeUpdate(query);
                    if (rs == 1){
